...
$StatusConfFile = icm -Session $session {ls $PathAgentConf}
Write-Host $srv - Created File: $StatusConfFile.Name -ForegroundColor Cyan
$StatusScriptFile = icm -Session $session {ls $PathAgentScript}
Write-Host $srv - Created File: $StatusScriptFile.Name -ForegroundColor Cyan
